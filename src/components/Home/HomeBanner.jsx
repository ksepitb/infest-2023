  ...
  return (
    ...
    '>
      ...
      <div className='absolute text-white max-w-[700px] p-5 md:ml-[3rem] flex flex-col gap-y-10 z-10 items-center md:items-start' data-aos='fade-up'>
        <p className='text-5xl font-bold text-center md:text-left text-shadow-lg'><span className='font-gradient font-extrabold-italic text-shadow-none'>The Biggest</span> Investment Festival Held by KSEP ITB</p>
        <Link to='https://forms.gle/vhGgY8nYfCXiimP87'  target='__blank'><button className='btn w-[150px] text-center lg:text-none py-3'>Daftar</button></Link>
      </div>
    </section>
  )
}
