        ...
        md:min-w-[75vw]'>
          <div className='relative z-10 bg-primary rounded w-[99%] h-[99%] p-10'>
            ...
            <div className='lg:w-[100%] md:w-[100%] mt-[28px] text-white font-book md:text-[16px] text-justify flex flex-col gap-y-2 md:gap-y-0 text-[12px]' >
              ...
              <p>7. Peserta tidak diperbolehkan menuliskan nama institusi asal peserta.</p>
              <p>8. Peserta wajib melakukan registrasi dan membayar biaya pendaftaran sesuai mekanisme pendaftaran.</p>
              <p>9. Peserta wajib mengikuti akun Instagram @infest.bdg untuk mendapatkan informasi mengenai perlombaan.</p>
              <p>10. Peserta wajib mem-posting twibbon yang disediakan oleh panitia untuk mengikuti lomba.</p>
              <p>11. Peserta wajib mengikuti ketentuan panitia dan keputusan panitia tidak dapat diganggu gugat.</p>
            </div>
          </div>
      </div>
    </section>
...
export default KetentuanBusiness