...
const Timeline = (props) => {
  return (
    <section className='mx-auto w-full h-[1500px] md:h-[1000px] bg-primary flex flex-col items-center'>
      <p className='font-extrabold-italic font-gradient text-5xl mb-[2.5rem]'>TIMELINE</p>
      <div className='mt-[5rem] h-[1300px] md:h-[800px] absolute left-50% w-[5px] bg-white rounded z-5' data-aos='zoom-in'/>
